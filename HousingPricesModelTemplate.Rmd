...
model_var = c('LogSalePrice', 
                'OverallQual','OverallCond','YearBuilt','ExterCondNum',
                'LogTotalBsmtSF','HeatingQCNum', 
                'CentralAirNum','BedroomAbvGr','KitchenAbvGr',
                'TotRmsAbvGrd','Fireplaces',
                'LogGarageArea','LogOpenPorchSF',
                 'YrSold', "LogGrLivArea",
               "LogWoodDeckSF","LogScreenPorch",
               "LogLotArea","LogMasVnrArea"
               )
...
# ols_step_both_p(home_reg, prem = .05, details = TRUE)
```
