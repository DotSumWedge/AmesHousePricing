...
AmesHouesingDataFrame$PoolArea = AmesHouesingDataFrame$PoolArea + 1

# Create log transformation column for the various porch square foot columns
AmesHouesingDataFrame$LogPoolArea = log(AmesHouesingDataFrame$PoolArea)

AmesHouesingDataFrame
```

```{r}
#Both pool aread and the log of pool area don't have a significant p value. There are also very few observations
