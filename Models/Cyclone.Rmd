...
```{r}
model = lm(LogSalePrice~LogGrLivArea+LogTotalBsmtSF+LogWoodDeckSF+LogOpenPorchSF+LogScreenPorch+LogLotArea+LogGarageArea+LogMasVnrArea, AmesHouesingDataFrame)
